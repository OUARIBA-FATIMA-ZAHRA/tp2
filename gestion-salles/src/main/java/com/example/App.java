...
public class App {
    ...
    private static void testCrudUtilisateur(UtilisateurService service) {
        ...
        Utilisateur u1 = new Utilisateur("Benali", "Fatima", "fatima@mail.com", 22, "ADMIN");
        u1.setDateNaissance(LocalDate.of(1985, 5, 15));
        u1.setTelephone("+33612345678");

        Utilisateur u2 = new Utilisateur("El Amrani", "Youssef", "youssef@mail.com", 25, "USER");
    ...
    private static void testCrudSalle(SalleService service) {
        ...
        Salle s1 = new Salle("Salle Informatique", 40, "TP");
        s1.setDescription("Salle de réunion équipée d'un projecteur");
        s1.setEtage(1);

        Salle s2 = new Salle("Salle Réunion", 20, "Réunion");
        s2.setDescription("Grand amphithéâtre pour conférences");
        s2.setEtage(2);

        Salle s3 = new Salle("Amphi A", 120, "Cours");
